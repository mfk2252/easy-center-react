...
export const SCALE_GOAL_TEMPLATES = {
  ...
  mchat_r_f: {
    1: {
      ...
      code: 'MCHAT-JA-1',
      title: 'تتبع إشارة الآخرين والاهتمام المشترك',
      goals: [
        { text: 'أن يتتبع الطفل اتجاه إشارة الأخصائي النظرية واليدوية نحو لعبة أو مجسم في الغرفة في 80% من المحاولات.', mastery: '4 من أصل 5 محاولات' }
      ]
    },
    3: {
      domain: 'play',
      code: 'MCHAT-PLAY-3',
      title: 'اللعب التظاهري والإيهامي',
      goals: [
        { text: 'أن يمارس الطفل نشاط لعب إيهامي بسيط (التظاهر بالشرب من كوب، إطعام دمية، الاتصال بهاتف لعبة) لمدة 3 دقائق.', mastery: 'لعب تظاهري مستقل' }
      ]
    },
    6: {
      domain: 'communication',
      code: 'MCHAT-COMM-6',
      title: 'الإشارة بالسبابة لطلب الأشياء والمساعدة',
      goals: [
        { text: 'أن يشير الطفل بإصبع السبابة بوضوح نحو الأشياء بعيدة المنال لطلبها من الوالدين أو الأخصائي بدلاً من البكاء.', mastery: 'في 80% من مواقف الطلب' }
      ]
    },
    7: {
      domain: 'joint_attention',
      code: 'MCHAT-JA-7',
      title: 'الإشارة بالسبابة لمشاركة الاهتمام',
      goals: [
        { text: 'أن يشير الطفل بإصبعه نحو حدث أو مجسم ملفت لمشاركة الاهتمام والتفاعل الاجتماعي مع الآخرين.', mastery: '3 مرات خلال الجلسة' }
      ]
    },
    8: {
      domain: 'social',
      code: 'MCHAT-SOC-8',
      title: 'التفاعل والاهتمام بالأقران',
      goals: [
        { text: 'أن يبدي الطفل اهتماماً بصرياً واجتماعياً بالأطفال الآخرين من خلال النظر إليهم والاقتراب والمشاركة في اللعب.', mastery: 'في 80% من فترات اللعب الحر' }
      ]
    },
    9: {
      domain: 'joint_attention',
      code: 'MCHAT-JA-9',
      title: 'إحضار الأشياء لمشاركة الاهتمام',
      goals: [
        { text: 'أن يحضر الطفل لعبة أو زهرة أو مجسم ورلرفه نحو الوالدين أو الأخصائي لمشاركته الإعجاب بها.', mastery: 'مشاركة تلقائية بنسبة 80%' }
      ]
    },
    10: {
      domain: 'joint_attention',
      code: 'MCHAT-JA-10',
      title: 'الاستجابة للنداء باسم الطفل',
      goals: [
        { text: 'أن يلتفت الطفل وينظر مباشرة نحو الفاحص أو الوالدين عند مناداته باسمه من مسافة 2 متر في 4 من 5 محاولات.', mastery: 'دقة 80% في الالتفات' }
      ]
    },
    11: {
      domain: 'social',
      code: 'MCHAT-SOC-11',
      title: 'تبادل الابتسام والتعبير الوجهي',
      goals: [
        { text: 'أن يبتسم الطفل استجابة لابتسامة الفاحص أو الوالدين ويظهر تعابير وجهية تفاعلية مشجعة.', mastery: 'تبادل اجتماعي في 80% من المواقف' }
      ]
    },
    14: {
      domain: 'social',
      code: 'MCHAT-SOC-14',
      title: 'التواصل البصري المباشر',
      goals: [
        { text: 'أن يحافظ الطفل على التواصل البصري المباشر مع المتحدث لمدة 3-5 ثوانٍ متواصلة أثناء الجلسة.', mastery: 'تواصل بصري مستدام 80%' }
      ]
    },
    15: {
      domain: 'imitation',
      code: 'MCHAT-IMIT-15',
      title: 'تقليد الحركات والتعابير والإيماءات',
      goals: [
        { text: 'أن يقلد الطفل إيماءات اجتماعية حركية (التلويح باليد باي باي، التصفيق، مسح الوجه) فور تقديم النموذج.', mastery: 'إتقان بنسبة 85%' }
      ]
    },
    16: {
      domain: 'joint_attention',
      code: 'MCHAT-JA-16',
      title: 'تتبع اتجاه نظرات الآخرين',
      goals: [
        { text: 'أن يدير الطفل رأسه ليتفقّد ما ينظر إليه الأخصائي عندما يحول نظره فجأة نحو شيء جانبي.', mastery: 'في 4 من أصل 5 محاولات' }
      ]
    },
    18: {
      domain: 'receptive',
      code: 'MCHAT-REC-18',
      title: 'استيعاب وتنفيذ التعليمات الشفهية',
      goals: [
        { text: 'أن ينفذ الطفل أمراً شفهياً بسيطاً من خطوة واحدة (ضع الكوب، أحضر الكرة) دون استخدام إشارات توضيحية.', mastery: 'استجابة صحيحة بنسبة 80%' }
      ]
    },
    19: {
      domain: 'social',
      code: 'MCHAT-SOC-19',
      title: 'المرجعية الاجتماعية وتفقد الانطباعات',
      goals: [
        { text: 'أن ينظر الطفل لوجه الوالدين أو الأخصائي لتفقد رد الفعل والاطمئنان عند وقوع أثر صوتي أو حدث مفاجئ.', mastery: 'في 80% من المواقف المفاجئة' }
      ]
    },
    20: {
      domain: 'play',
      code: 'MCHAT-PLAY-20',
      title: 'المشاركة في الألعاب الحركية التفاعلية',
      goals: [
        { text: 'أن يشارك الطفل بابتهاج وفاعلية في الألعاب الحركية التفاعلية (الهز، الدغدغة، الأرجحة) ويطلب الاستمرار.', mastery: 'مشاركة تفاعلية مبتهجة' }
      ]
    }
  },
