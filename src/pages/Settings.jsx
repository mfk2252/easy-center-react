...
export default function Settings() {
  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', paddingBottom: 40 }}>
      ...
      ────────────────────────────────────────────────────────────── */}
      {tab === 'appearance' && (() => {
        const activeSavedFont = localStorage.getItem('scs_fontfamily') || center.fontFamily || 'almarai';
        const activeSavedSize = Number(localStorage.getItem('scs_fontsize')) || 16;
        const activeSavedWeight = localStorage.getItem('scs_fontweight') || '400';
            ...
            <div className="wg" style={{ margin: 0 }}>
              ...
              <div className="wg-b" style={{ padding: '22px' }}>
                ...
                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 18 }}>
                  ...
                  >
                    🔄 ضبط النموذج على الإعدادات الافتراضية (خط المراعي 16px)
                  </button>
                ...
                <div className="fg c2" style={{ marginBottom: 24 }}>
                  <div style={{ padding: '16px', background: 'var(--g0)', borderRadius: 12, border: '1px solid var(--border-color)' }}>
                    ...
                    <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                      ...
                      <div style={{
                        ...
                        {fontSize}px {fontSize === 16 && <span style={{ fontSize: '.75rem', color: 'var(--ok)', fontWeight: 700 }}>(الافتراضي)</span>}
                      </div>
                      ...
                      <button
                        ...
                        title="إعادة ضبط حجم الخط على 16px الافتراضي"
                  ...
                  <div style={{ padding: '16px', background: 'var(--g0)', borderRadius: 12, border: '1px solid var(--border-color)' }}>
                    ...
                    >
                      ...
                      <option value="400">عادي (400) - الافتراضي</option>
