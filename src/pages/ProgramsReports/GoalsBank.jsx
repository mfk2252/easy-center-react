...
/**
 * يجمع البذور الثابتة + إضافات المركز الخاصة (مخزَّنة في Firestore/محلياً تحت
 * مفتاح progGoalsBank، معزولة تلقائياً حسب المركز مثل أي بيانات أخرى).
 */
...
/**
 * نافذة اختيار أهداف من بنك متعدد البرامج لمجال معيّن — الفكرة الجوهرية
 * لطلبك: يمكن اختيار بنود من لوفاس وبورتاج وإيبلز معاً لنفس المجال، وليس
 * الالتزام ببرنامج واحد فقط.
 */
export function GoalPickerModal({ domain, alreadySelected, onConfirm, onClose }) {
  ...
  function confirm() {
    ...
    // بنود كُتبت للتو ولم تُحفظ بالبنك (saveToBank=false) تُضاف كنص خام بدون معرّف بنك
...
/**
 * إدارة بنك الأهداف الخاص بالمركز — عرض/حذف البنود المخصّصة (البذور الثابتة
 * لا تُحذف، فهي مرجع أساسي مشترك لكل المراكز ولا تُعدَّل من هنا).
 */
