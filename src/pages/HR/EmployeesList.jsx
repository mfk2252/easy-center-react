...
/**
 * قائمة الموظفين وملفاتهم — نظام مستقل ضمن لوحة "الموظفون".
 * إضافة موظف جديد أصبحت زراً ثانوياً هنا (وليست بارزة في أعلى القسم كله)،
 * لأن مراكز التربية الخاصة لا تضيف موظفين يومياً كما توضّح.
 */
