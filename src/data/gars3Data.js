...
export const GARS3_RESPONSE_OPTIONS = [
  { value: 0, label: 'أبداً (0)', hint: 'لم يلاحظ السلوك إطلاقاً على الطفل' },
  { value: 1, label: 'نادراً (1)', hint: 'يأتي السلوك مرة أو اثنتين في فترات متباعدة' },
  { value: 2, label: 'أحياناً (2)', hint: 'يأتي بالسلوك ما بين 3 إلى 4 مرات كل 6 ساعات' },
  { value: 3, label: 'كثيراً جداً / نعم (3)', hint: 'يأتي بالسلوك من 5 إلى 6 مرات أو أكثر كل 6 ساعات' },
];
